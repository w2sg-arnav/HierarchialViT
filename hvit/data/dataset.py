# hvit/data/dataset.py
"""SAR-CLD-2024 cotton leaf disease dataset utilities.

This module provides dataset classes for loading and processing
the SAR-CLD-2024 cotton leaf disease dataset.
"""
...
class BaseSARCLD2024Dataset(Dataset[Tuple[torch.Tensor, int]]):
    ...
    def _create_split(self) -> None:
        ...
        if self.split == "train":
            ...
            raise ValueError(
                f"Invalid split name: '{self.split}'. "
...
class SARCLD2024Dataset(BaseSARCLD2024Dataset):
    ...
    def __getitem__(self, idx: int) -> Tuple[torch.Tensor, int]:
        ...
        try:
            ...
            # If no transform, raise an error
