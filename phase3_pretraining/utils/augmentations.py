...
class SimCLRAugmentation:
    def __init__(self, img_size: tuple,
        ...
        self.transform = T_v2.Compose([
            T_v2.RandomResizedCrop(size=img_size, scale=(_rrc_scale_min, 1.0), antialias=True),
            ...
            # SimCLR typically does not include normalization in the augmentation pipeline itself,
            # as the InfoNCE loss works on (normalized) feature vectors.
            # Input to this __call__ should be [0,1] tensor.
        ])
